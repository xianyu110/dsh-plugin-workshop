window.__ModuleLoader__.load({ id: "@dsh-external/dsh-plugin-workshop", factory: (require) => {
var module = { exports: {} }; var exports = module.exports;
/**
 * dsh-plugin-workshop（浏览器端源码）v1.4.4
 *
 * 常驻版插件工坊：
  ...
  function Workshop(props) {
    ...
    function isInstalled(full) {
      ...
      return deps.some(function (d) {
        ...
        return reGithub.test(s) || reLink.test(s) || (s.indexOf(fullLower) >= 0 && s.indexOf('.agent-presets') < 0)
      })
    }
