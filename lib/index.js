/**
 * dsh-plugin-workshop（宿主侧）v1.3.1
 *
 * 智能一键安装/卸载：
 ...
 * - GET /dsh-plugin-workshop/api/uninstall → 按安装方式逆向清理：
...
function scheduleRestart() {
  ...
  try {
    ...
    const child = spawn('cmd', ['/c', 'start', '""', '/min', 'cmd', '/c', q(file)], { detached: true, stdio: 'ignore', windowsHide: true })
    child.unref()
    return true
  } catch (e) {
    return false
